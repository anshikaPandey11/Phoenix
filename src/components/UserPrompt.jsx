...
const UserPrompt = ({ text }) => {
    ...
    //Use the useToggle hook to mange the expanded state of the user prompt text.
    const [isExpanded, toggleExpand] = useToggle();

    // Create a ref to access the text box element in the DOM.
    const textBoxRef = useRef();

    // Initialize the hasMoreContent state, indicating whether the content exceed the visible height of the text box.
    ...
    return (
      <div className='grid grid-cols-1 items-start_gap-1 py-4 md:grid-cols-[max-content,minmax(0,1fr),max-content] md:gap-5'>
