...
const Greetings = () => {
    // Load the user data from the loader data using the userLoaderData hook.
        ...
        <>
            ...
            ">
                <motion.span
                    ...
                    className="bg-gradient-to-r from-teal-400 from-0% via-cyan-500 via-56% to-transparent to-75% bg-[length:350%_100%] bg-[100%_0] bg-clip-text text-transparent">Hello,{user.name.split(' ').at()}</motion.span>
                <br />
                <motion.span 
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    ...
                    className="dark:font-medium">How can I help?</motion.span>
            </h2>
        </div>  
           )} 
        </>
